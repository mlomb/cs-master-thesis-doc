...
% The value of the evaluation is defined from the point of view of the player to move in the initial position. In practice, the value of the evaluation is defined from the point of view of the player to move, negating 
% The value is defined from the perspective of the player to move, however for simplicity we will assume that 
