...
\item \textbf{Move ordering}: the order in which the moves are evaluated can have a big impact on the effectiveness of the alpha-beta pruning. There are a couple of ways to improve move ordering:
\begin{itemize}
