...
\subsubsection{\mdseries\featureset{Piece}}
...
\subsubsection{\mdseries\featureset{Compact}}
...
\subsubsection{\mdseries\featureset{King-Piece}}
...
There are variations to this feature set, such as \featureset{HalfKAv2} or notably \featureset{HalfKAv2\_hm} that is currently the latest feature set used by Stockfish 16.1. I will not consider them in this work.
...
\subsubsection{\mdseries\featureset{Piece-Move}}
...
\subsubsection{\mdseries\featureset{Half-Relative(H$|$V$|$HV)King-Piece}}
...
\subsubsection{\mdseries\featureset{Half-Top(PP)}}
