...
\begin{tabular}{ccc}
\toprule
\bf Block name & \bf Definition & \makecell{\bf Number\\ of features} \\
\toprule
MB & \makecell{
\vspace{0.2cm}
...
\toprule
MC & \makecell{
$(M(R) \times \featureset{Roles} \times \featureset{Colors})_{P}$\\
\vspace{0.2cm}
$M(r)=\{0\hdots\}$ are the mobility values for the role $r$\\
