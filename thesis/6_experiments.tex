...
Depiction & Feature set \\
\midrule
\axisarrows{HV} & \featureset{Piece}  \\
\midrule
\axisarrows{H} $\oplus$ \axisarrows{V} & \featureset{Piece}  \\
\midrule
\axisarrows{D1D2} & \featureset{Piece}  \\
\midrule
\axisarrows{D1} $\oplus$ \axisarrows{D2} & \featureset{Piece}  \\
\midrule
